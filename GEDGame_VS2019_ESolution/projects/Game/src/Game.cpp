        ...
        const DXGI_SURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
    ...
    shadow_desc.Width = g_ConfigParser.get_ShadowRes();
    shadow_desc.Height = g_ConfigParser.get_ShadowRes();
    ...
    g_ShadowViewport[0].Width = g_ConfigParser.get_ShadowRes();
    g_ShadowViewport[0].Height = g_ConfigParser.get_ShadowRes();
...
void SpawnEnemy()
{
    ...
    XMVECTOR target_pos = {
        ...
        spawn_height* g_ConfigParser.get_TerrainHeight(),
